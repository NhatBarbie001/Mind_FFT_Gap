...
import warnings
from loraclip.loralib.layers import Linear, Conv2d, Embedding, MergedLinear, LoRALayer, multi_head_attention_forward, MultiheadAttention


class MultiheadAttention_FFT(MultiheadAttention):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None, lora_alpha: int = 1, r=0, only_kv=False, mlp=False,
        ...
        super().__init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None, lora_alpha = 1, r=0, only_kv=False, mlp=False)
    ...
    #================== Chua sua, hay sua doan code nay ?=============================================================
    def init_param(self):
